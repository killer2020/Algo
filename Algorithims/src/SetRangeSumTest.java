...
public class SetRangeSumTest {
    ...
    void erase(int x) {
    	...
    	//Vertex temp=new Vertex(root.right.key,0,root.left,root.right.right,null);
    	temp.left=root.left;
    ...
    boolean find(int x) {
       ...
       if(leftRight.right==null)
    	   return false;
       if(leftRight.right.key!=x)
   		return false;
       
        //root=splay(leftRight.left);
        return true;
    }
    ...
    void solve() throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (type) {
                ...
                case '?' : {
                    int x = nextInt();
                    out.println(find(x) ? "Found" : "Not found");
                } break;
                case 's' : {
                    int l = nextInt();
                    int r = nextInt();
    ...
    SetRangeSumTest() throws IOException {
